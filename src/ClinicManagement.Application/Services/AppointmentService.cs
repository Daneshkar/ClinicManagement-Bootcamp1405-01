    ...
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<DoctorAvailableSlotsResponseDto> GetAvailableSlotsAsync(string medicalId, DateTime startDate)
        {
            ...
            var bookedAppointments =
                await _appointmentRepository.GetBookedVisitDatesAsync(medicalId, rangeStart, rangeEnd);
        ...
        public async Task<AppointmentCreateResponseDto> BookAppointmentAsync(AppointmentCreateRequestDto request)
        {
            ...
            var appointmentIsReserved =
                await _appointmentRepository.ExistsAsync(request.DoctorMedicalId, request.VisitDate);
            ...
            return new AppointmentCreateResponseDto(IsSuccess: true, Message: "appointment reserved successfully",
                VisitDate: request.VisitDate);
        }
